...
const dict = {
  id: {
    ...
    ad_modal_title: "Menampilkan Iklan Sponsor",
    ad_of: "Iklan",
    ad_skip_soon: "Iklan berikutnya sebentar lagi...",
    ad_close: "Tutup",
    start_ads: "Mulai Tonton Iklan",
    unlocked_title: "Generator Terbuka!",
    unlocked_body: "Kamu sudah menyelesaikan semua iklan. Silakan generate akun premium.",
    history_title: "Riwayat Aktivitas",
    history_date: "Tanggal",
    history_email: "Akun Email",
    history_status: "Status",
    history_empty: "Belum ada riwayat aktivitas.",
    history_clear: "Hapus Riwayat",
  ...
  en: {
    ...
    hero_badge: "PREMIUM // BETA v2",
    ad_modal_title: "Sponsored Ad Playing",
    ad_of: "Ad",
    ad_skip_soon: "Next ad in a moment...",
    ad_close: "Close",
    start_ads: "Start Watching Ads",
    unlocked_title: "Generator Unlocked!",
    unlocked_body: "You've completed all ads. Go ahead and generate your premium account.",
    history_title: "Activity History",
    history_date: "Date",
    history_email: "Email Account",
    history_status: "Status",
